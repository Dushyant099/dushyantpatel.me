...
//todo add php content from here
...
<html lang="en">
	<head>
		...
		<title>Home Version Coming Soon 1 | Minth</title>
	...
	<body class="theme-background coming-soon">
		...
		<div class="theme-background-section full-screen fs-overlay" style="background-image: url('../images/coming-soon-2.jpg'); " data-custom-height="" data-offset-container="">
			<div class="content-container">
				<div class="content-inner-container text-center">
					<div class="coming-soon-sections intro active-section">
						<div class="container-fluid">
							<div class="row">
								<div class="col-md-6 col-md-offset-3 text-light">
									<h1 class="text-uppercase fancy-heading letter-spacing-2 animated slideInDown weight-400 true-size-mobile true-size-tablet" style="font-size: 100px;">Coming Soon</h1>
									<h3 class="text-uppercase no-margin pad-bot-30 text-lighter letter-spacing-2 animated slideInDown">I am working on some Awesomeness!</h3>
									<div id="countdown" class="text-secondary pad-bot-30 text-uppercase mar-bot-100 letter-spacing-2 animated slideInDown" style="font-size:24px;"></div>
								</div>
								<div class="row">
									<div class="col-md-12 ">
										<a href="http://www.dushyantpatel.me" class="btn btn-lg btn-light animated slideInDown">Home</a>
									</div>
								</div>
		...
		<script src="third-party/countdown/js/jquery.countdown.min.js"></script>
